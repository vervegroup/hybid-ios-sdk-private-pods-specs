Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/pubnative/pubnative-hybid-ios-sdk-private.git", :branch => "feature/survey-support" }
  s.resource_bundle = {
  ...
  s.subspec 'ATOM' do |atom|
    ...
    atom.dependency 'ATOM-Standalone-Private', '3.9.0-beta.149'
  end
